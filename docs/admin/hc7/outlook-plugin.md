...
[Following page](https://help.hcl-software.com/connections/latest/connectors/enduser/t_ms_plugins_outlook_add_in_features.html){target="_blank"} from the HCL documentation explains how to use this feature.

## Installing the plugin

### As an Entra Administrator

As an Entra administrator you can deploy the plugin for all your users. See [this](https://help.hcl-software.com/connections/latest/admin/install/cp_3p_outlook_make_available_to_users.html?h=outlook+plugin){target="_blank"} document from HCL for reference.
