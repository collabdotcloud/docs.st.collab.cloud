...
Official [HCL Documentation](https://help.hcl-software.com/connections/latest/connectors/admin/c_admin_sharepoint_app_container.html){target="_blank"}

First you need to configure the [Sharepoint app](https://help.hcl-software.com/connections/latest/connectors/admin/t_admin_sharepoint_app_enabling.html?h=sharepoint){target="_blank"} which returns a client-id.
This client-id together with your site url is used to [configure and enable the Sharepoint](https://help.hcl-software.com/connections/latest/connectors/admin/t_admin_sharepoint_app_configure.html){target="_blank"} widget in our Appregistry.
